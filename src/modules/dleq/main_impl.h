...
static void secp256k1_nonce_function_dleq(const secp256k1_hash_ctx *hash_ctx, unsigned char *nonce32, const unsigned char *key32, const unsigned char *A_33, const unsigned char *C_33, const unsigned char *aux_rand32, const unsigned char *msg32) {
    ...
    /* Hash masked-key||A||C||msg32 using the tagged hash as defined in BIP0374 */
    secp256k1_sha256_write(hash_ctx, &sha, masked_key, 32);
    secp256k1_sha256_write(hash_ctx, &sha, A_33, 33);
    secp256k1_sha256_write(hash_ctx, &sha, C_33, 33);
    if (msg32 != NULL) {
...
static int secp256k1_dleq_nonce(const secp256k1_hash_ctx *hash_ctx, secp256k1_scalar *k, const unsigned char *a32, const unsigned char *A_33, const unsigned char *C_33, const unsigned char *aux_rand32, const unsigned char *msg32) {
    unsigned char nonce[32];
    int ret;

    secp256k1_nonce_function_dleq(hash_ctx, nonce, a32, A_33, C_33, aux_rand32, msg32);
...
static void secp256k1_dleq_challenge(const secp256k1_hash_ctx *hash_ctx, secp256k1_scalar *e, secp256k1_ge *A, secp256k1_ge *B, secp256k1_ge *C, secp256k1_ge *R1, secp256k1_ge *R2, const unsigned char *msg32) {
    ...
    if (msg32) secp256k1_sha256_write(hash_ctx, &sha, msg32, 32);
...
static void secp256k1_dleq_pair(const secp256k1_ecmult_gen_context *ecmult_gen_ctx, secp256k1_ge *A, secp256k1_ge *C, const secp256k1_scalar *a, const secp256k1_ge *B) {
    ...
    /* Cj is derived from the secret scalar a, so clear it. */
    secp256k1_gej_clear(&Cj);
}
 ...
 *      msg32 : an optional 32-byte message
 * */
static int secp256k1_dleq_prove_internal(const secp256k1_context *ctx, secp256k1_scalar *e, secp256k1_scalar *s, const secp256k1_scalar *a, secp256k1_ge *B, secp256k1_ge *A, secp256k1_ge *C, const unsigned char *aux_rand32, const unsigned char *msg32) {
    ...
    ret = secp256k1_dleq_nonce(hash_ctx, &k, a32, A_33, C_33, aux_rand32, msg32);
    ...
    /* e = tagged hash(A, B, C, G, R1, R2, msg32) */
    /* s = k + e * a */
    secp256k1_dleq_challenge(hash_ctx, e, A, B, C, &R1, &R2, msg32);
 ...
 *      msg32 : an optional 32-byte message
 * */
static int secp256k1_dleq_verify_internal(const secp256k1_hash_ctx *hash_ctx, const secp256k1_scalar *e, const secp256k1_scalar *s, secp256k1_ge *A, secp256k1_ge *B, secp256k1_ge *C, const unsigned char *msg32) {
    ...
    secp256k1_dleq_challenge(hash_ctx, &e_expected, A, B, C, &R1, &R2, msg32);
...
int secp256k1_dleq_prove(
    ...
    ret = secp256k1_dleq_prove_internal(ctx, &e, &s, &a, &B, &A, &C, aux_rand32, msg32);
...
int secp256k1_dleq_verify(
    ...
    return secp256k1_dleq_verify_internal(&ctx->hash_ctx, &e, &s, &A, &B, &C, msg32);
}
